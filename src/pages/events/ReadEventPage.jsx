    ...
    <div className="container m-5">
      <div className="row d-flex justify-content-center">
        <div className="col-10">
          <Link to={"/eventos"} type="button" className="btn btn-primary mb-3">
          ...
          <div className="card border-info mb-3" >
            <div className="card-body">
              ...
              <div className="d-grid gap-2 d-md-block mt-3">
                <Link to={`/teacher/accepted/${id}`} type="button" className="btn btn-primary">
                  <i className="bi bi-person-check"></i> Ver solicitudes aceptadas
                </Link>
                <Link to={`/teacher/rejected/${id}`} type="button" className="btn btn-secondary mx-3">
